...
def DolphinLib(lib_name: str, objects: Objects, fix_epilogue=False) -> Library:
    cflags = cflags_base + [
        "-requireprotos",
        "-fp_contract off",
        "-ir extern/aurora/lib",
    ]
    src_dir = "extern/aurora/lib"
    includes = [
        "extern/aurora/include",
    "extern/dolphin/include",
        "extern/aurora/include/libc",
...
config.libs = [
    ...
    DolphinLib(
        "amcstubs",
        [
            #Object(Matching, "dolphin/amcstubs/AmcExi2Stubs.c") # missing in aurora,
        ],
    ),
    DolphinLib(
        "OdemuExi2",
        [
            #Object(Matching, "dolphin/odenotstub/odenotstub.c") # missing in aurora,
        ],
    ),
    DolphinLib(
        "hio",
        [
            #Object(Matching, "dolphin/hio/hio.c") # missing in aurora,
        ],
        fix_epilogue=True,
    ),
    DolphinLib(
        "mcc",
        [
            #Object(Matching, "dolphin/mcc/mcc.c") # missing in aurora,
            #Object(Matching, "dolphin/mcc/fio.c") # missing in aurora,
        ],
    ),
    DolphinLib(
        "thp",
        [
            Object(Matching, "dolphin/thp/THPDec.cpp"),
        ],
    ),
    DolphinLib(
        "base",
        [
            #Object(Matching, "dolphin/base/PPCArch.c") # missing in aurora,
        ],
    ),
    DolphinLib(
        "db",
        [
            #Object(Matching, "dolphin/db/db.c") # missing in aurora,
        ],
    ),
    DolphinLib(
        "dsp",
        [
            #Object(Matching, "dolphin/dsp/dsp.c") # missing in aurora,
            #Object(Matching, "dolphin/dsp/dsp_debug.c") # missing in aurora,
            #Object(Matching, "dolphin/dsp/dsp_task.c") # missing in aurora,
        ],
    ),
    DolphinLib(
        "dvd",
        [
            #Object(Matching, "dolphin/dvd/dvdlow.c") # missing in aurora,
            #Object(Matching, "dolphin/dvd/dvdfs.c") # missing in aurora,
            Object(Matching, "dolphin/dvd/dvd.cpp"),
            #Object(Matching, "dolphin/dvd/dvdqueue.c") # missing in aurora,
            #Object(Matching, "dolphin/dvd/dvderror.c") # missing in aurora,
            #Object(Matching, "dolphin/dvd/fstload.c") # missing in aurora,
        ],
    ),
    DolphinLib(
        "gx",
        [
            #Object(Matching, "dolphin/gx/GXInit.c") # missing in aurora,
            Object(Matching, "dolphin/gx/GXFifo.cpp"),
            #Object(Matching, "dolphin/gx/GXAttr.c") # missing in aurora,
            #Object(Matching, "dolphin/gx/GXMisc.c") # missing in aurora,
            Object(Matching, "dolphin/gx/GXGeometry.cpp"),
            #Object(Matching, "dolphin/gx/GXFrameBuf.c") # missing in aurora,
            #Object(Matching, "dolphin/gx/GXLight.c") # missing in aurora,
            Object(Matching, "dolphin/gx/GXTexture.cpp"),
            Object(Matching, "dolphin/gx/GXBump.cpp"),
            Object(Matching, "dolphin/gx/GXTev.cpp"),
            Object(Matching, "dolphin/gx/GXPixel.cpp"),
            #Object(Matching, "dolphin/gx/GXStubs.c") # missing in aurora,
            #Object(Matching, "dolphin/gx/GXDisplayList.c") # missing in aurora,
            Object(Matching, "dolphin/gx/GXTransform.cpp"),
            Object(Matching, "dolphin/gx/GXPerf.cpp"),
        ],
    ),
    DolphinLib(
        "mtx",
        [
            #Object(Matching, "dolphin/mtx/mtx.c") # missing in aurora,
            #Object(Matching, "dolphin/mtx/mtxvec.c") # missing in aurora,
            #Object(Matching, "dolphin/mtx/mtx44.c") # missing in aurora,
            #Object(Matching, "dolphin/mtx/vec.c") # missing in aurora,
        ],
        fix_epilogue=True,
    ),
    DolphinLib(
        "os",
        [
            #Object(Matching, "dolphin/os/OS.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSAlarm.c") # missing in aurora,
            Object(Matching, "dolphin/os/OSAlloc.cpp"),
            Object(Matching, "dolphin/os/OSArena.cpp"),
            #Object(Matching, "dolphin/os/OSAudioSystem.c") # missing in aurora,
            Object(Matching, "dolphin/os/OSCache.cpp"),
            #Object(Matching, "dolphin/os/OSContext.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSError.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSExi.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSFont.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSInterrupt.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSLink.c") # missing in aurora,
            Object(Matching, "dolphin/os/OSMemory.cpp"),
            #Object(Matching, "dolphin/os/OSMutex.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSReboot.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSReset.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSResetSW.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSRtc.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSSerial.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSSync.c") # missing in aurora,
            #Object(Matching, "dolphin/os/OSThread.c") # missing in aurora,
            Object(Matching, "dolphin/os/OSTime.cpp"),
            #Object(Matching, "dolphin/os/OSUartExi.c") # missing in aurora,
            #Object(Matching, "dolphin/os/init/__start.c") # missing in aurora,
            #Object(Matching, "dolphin/os/init/__ppc_eabi_init.c") # missing in aurora,
        ],
    ),
    DolphinLib(
        "pad",
        [
            #Object(Matching, "dolphin/pad/PadClamp.c") # missing in aurora,
            Object(Matching, "dolphin/pad/pad.cpp"),
        ],
        fix_epilogue=True,
    ),
    DolphinLib(
        "vi",
        [
            Object(Matching, "dolphin/vi/vi.cpp"),
        ],
    ),
    DolphinLib(
        "ai",
        [
            #Object(Matching, "dolphin/ai/ai.c") # missing in aurora,
        ],
    ),
    DolphinLib(
        "ar",
        [
            Object(Matching, "dolphin/AR.cpp"),
            #Object(Matching, "dolphin/ar/arq.c") # missing in aurora,
        ],
    ),
    DolphinLib(
        "card",
        [
            Object(Matching, "dolphin/card.cpp"),
            #Object(Matching, "dolphin/card/CARDUnlock.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDRdwr.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDBlock.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDDir.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDCheck.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDMount.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDFormat.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDOpen.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDCreate.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDRead.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDWrite.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDDelete.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDStat.c") # missing in aurora,
            #Object(Matching, "dolphin/card/CARDRename.c") # missing in aurora,
        ],
        fix_epilogue=True,
    ),
    DolphinLib(
        "ax",
        [
            #Object(Matching, "dolphin/ax/AX.c") # missing in aurora,
            #Object(Matching, "dolphin/ax/AXAlloc.c") # missing in aurora,
            #Object(Matching, "dolphin/ax/AXAux.c") # missing in aurora,
            #Object(Matching, "dolphin/ax/AXCL.c") # missing in aurora,
            #Object(Matching, "dolphin/ax/AXOut.c") # missing in aurora,
            #Object(Matching, "dolphin/ax/AXSPB.c") # missing in aurora,
            #Object(Matching, "dolphin/ax/AXVPB.c") # missing in aurora,
            #Object(Matching, "dolphin/ax/AXProf.c") # missing in aurora,
            #Object(Matching, "dolphin/ax/DSPCode.c") # missing in aurora,
        ],
    ),
    DolphinLib(
        "axfx",
        [
            #Object(Matching, "dolphin/axfx/reverb_hi.c") # missing in aurora,
            #Object(Matching, "dolphin/axfx/reverb_std.c") # missing in aurora,
            #Object(Matching, "dolphin/axfx/chorus.c") # missing in aurora,
            #Object(Matching, "dolphin/axfx/delay.c") # missing in aurora,
            #Object(Matching, "dolphin/axfx/axfx.c") # missing in aurora,
        ],
    ),
    SysdolphinLib(
